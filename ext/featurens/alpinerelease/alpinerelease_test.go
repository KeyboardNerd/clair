...
func TestDetector(t *testing.T) {
	testData := []featurens.TestData{
		{
			ExpectedNamespace: &database.Namespace{Name: "alpine", Version: "v3.3"},
			Files:             tarutil.FilesMap{"etc/alpine-release": []byte(`3.3.4`)},
		},
		{
			ExpectedNamespace: &database.Namespace{Name: "alpine", Version: "v3.4"},
			Files:             tarutil.FilesMap{"etc/alpine-release": []byte(`3.4.0`)},
		},
		{
			ExpectedNamespace: &database.Namespace{Name: "alpine", Version: "v0.3"},
