...
import "github.com/coreos/clair/pkg/dbutil"
...
var (
	...
	// layers.
	ancestry = dbutil.MigrationQuery{
		Up: []string{
			// ancestry
	...
	vulnerability = dbutil.MigrationQuery{
		Up: []string{
	...
	updaterLock = dbutil.MigrationQuery{
		Up: []string{
	...
	notification = dbutil.MigrationQuery{
		Up: []string{
